...
return [
    'ctrl' => [
        ...
        'typeicon_classes' => [
            'default' => 'dyn_be_layouts-ext-icon',
        ],
    ],
    'types' => [
        '0' => ['showitem' => '
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_dynbelayouts_domain_model_layout}.{#pid}=###CURRENT_PID### AND {#tx_dynbelayouts_domain_model_layout}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_source' => [
